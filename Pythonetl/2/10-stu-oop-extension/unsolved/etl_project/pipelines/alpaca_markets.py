...
import os 
from etl_project.assets.alpaca_markets import extract, extract_exchange_codes, transform, load
...
if __name__ == "__main__":
    ...
    df_alpaca_markets = extract(alpaca_markets_client=alpaca_markets_client, stock_ticker="tsla", start_date="2020-01-01", end_date="2020-01-03")
    ...
    load(df_exchange=df_exchange,postgresql_client=postgresql_client, table=table, metadata=metadata)
